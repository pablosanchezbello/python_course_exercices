...
INSERT INTO "user" (username, email, hashed_password, role) VALUES
('user1', 'user1@example.com', '$2b$12$examplehashedpassword1', 'user'),
('user2', 'user2@example.com', '$2b$12$examplehashedpassword2', 'user'),
('admin1', 'admin1@example.com', '$2b$12$examplehashedpassword3', 'admin'),
('admin2', 'admin2@example.com', '$2b$12$examplehashedpassword4', 'admin');
